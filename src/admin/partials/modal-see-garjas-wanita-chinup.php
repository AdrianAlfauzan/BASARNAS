<div class="modal fade" id="lihatGarjasWanitaChinUp" tabindex="-1" aria-labelledby="lihatGarjasWanitaChinUpLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="">Info Garjas Wanita (Chin Up)</h1>
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td id="lihatJumlahChinUpWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Nilai Chin Up:</th>
                                <td id="lihatNilaiChinUpWanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Tanggal Pelaksanaan:</th>
                                <td id="tanggalPelaksanaanChinUpWanitaGW"></td>
                            </tr>
                        </table>
                    </div>
                </div>
