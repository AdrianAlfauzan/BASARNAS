<div class="modal fade" id="lihatGarjasWanitaSitUp2" tabindex="-1" aria-labelledby="lihatGarjasWanitaSitUp2Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="">Info Garjas Wanita (Sit Up Kaki Ditekuk)</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <th>Jumlah Sit Up:</th>
                                <td id="lihatJumlahSitUp2WanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Nilai Sit Up:</th>
                                <td id="lihatNilaiSitUp2WanitaGW"></td>
                            </tr>
                            <tr>
                                <th>Tanggal Pelaksanaan:</th>
                                <td id="tanggalPelaksanaanSitUp2WanitaGW"></td>
                            </tr>
                        </table>
                    </div>
                </div>
